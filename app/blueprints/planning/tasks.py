...
def _generate_objections(metadata, document_texts, reference, analysis):
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", (
            ...
            "## YOUR PRIMARY TASK:\n"
            "Analyse the specific planning application below and produce between 2 and 5 "
            "DISTINCT objections. Each objection must address a DIFFERENT planning concern "
            ...
            "## WHAT NOT TO DO:\n"
            "- Do NOT produce only 1 objection that summarises everything\n"
        ...
        ("human", (
            ...
            "Now produce 2-5 separate objections specific to this application. "
